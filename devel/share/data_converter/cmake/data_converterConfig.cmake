...
if("TRUE" STREQUAL "TRUE")
  set(data_converter_SOURCE_PREFIX /home/doopy/Documents/ros_tango/src/data_converter)
  set(data_converter_DEVEL_PREFIX /home/doopy/Documents/ros_tango/devel)
  ...
  set(data_converter_INSTALL_PREFIX /home/doopy/Documents/ros_tango/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'data_converter' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'doopy <doopy@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'data_converter' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/doopy/Documents/ros_tango/src/data_converter/${idir}'.  Ask the maintainer 'doopy <doopy@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/doopy/Documents/ros_tango/devel/lib;/home/doopy/Documents/ros_tango/devel/lib;/opt/ros/indigo/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${data_converter_dep}_FOUND)
      find_package(${data_converter_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${data_converter_dep} REQUIRED ${depend_list})
  endif()
